...
Set-Content -Path ../src/AdminSite/appsettings.Development.json -value "{`"SaaSApiConfiguration`":{`"KeyVault`": `"$KeyVault`", `"ClientCertificate`": `"$CertificateName`", `"ClientCertificatePassword`": `"$certPassword`"}, `"ConnectionStrings`": {`"DefaultConnection`":`"$Connection`"}}"
